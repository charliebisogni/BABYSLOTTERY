...
// Plantilla del correo para el ganador con URL de logo actualizada y charset UTF-8
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const { data, error } = await resend.emails.send({
      from: 'Baby\'s Lottery <felicidades@babyslottery.lat>', // ¡ASEGÚRATE de que babyslottery.lat sea tu dominio verificado!
      to: [emailGanador],
